...
def sequence(*layers):
    ...
    ```python
        from keras.layers import Dense, Input, sequence
...
def repeat(n, layer_factory):
    ...
    ```python
        from keras.layers import Dense, Input, repeat, sequence
        from keras.models import Model
    ...
    ```python
        from keras.layers import Activation, Dense, Input, repeat, sequence
        from keras.models import Model
